...
-- Device public keys used by mandate relay receipts.
-- device_id is text to match existing extension/desktop/CLI device IDs.
...
-- Session mandates are the relay's signed authorization records.
...
-- Period receipts are permanent, signed, auditable records.
...
-- Byte tokens are relay-generated proof of traffic flow.
...
-- Commit/reveal lock records for each receipt period.
